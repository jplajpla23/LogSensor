...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><center><h4>New Alert for: <?php echo e($sensor->name); ?></h4></center></div><br>
                <div class="card-body">
                    <div id="form" >
                        <!--create form-->
                        <?php if($errors->any()): ?>
                        ...
                        <form style="margin: 25px!important;" method="POST" action="<?php echo e(route('alert_new')); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($sensor->id); ?>">
                            <div class="row">
                                <div class="form-group" style="width: 98%!important;" >
                                    <label for="desc">Description</label>
                                    <input type="text" class="form-control col-md-12" id="name" name="desc" required value="<?php echo e(old('desc')); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group" style="width: 98%!important;" >
